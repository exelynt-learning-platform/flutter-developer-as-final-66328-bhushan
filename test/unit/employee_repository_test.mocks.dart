...
// in employee_management_application_flutter_assessment/test/unit/employee_repository_test.dart.
...
class MockDioHelper extends _i1.Mock implements _i3.DioHelper {
  ...
  @override
  _i4.Future<dynamic> post(String? url, Map<String, dynamic>? data) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<dynamic> put(String? url, Map<String, dynamic>? data) =>
      (super.noSuchMethod(
            Invocation.method(#put, [url, data]),
            returnValue: _i4.Future<dynamic>.value(),
          )
          as _i4.Future<dynamic>);
