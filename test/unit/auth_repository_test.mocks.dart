...
// in employee_management_application_flutter_assessment/test/unit/auth_repository_test.dart.
...
class MockAuthRepository extends _i1.Mock implements _i9.AuthRepository {
  ...
  @override
  _i6.Future<_i4.UserCredential> signInWithEmail(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<_i4.UserCredential> registerWithEmail(
    String? email,
    String? password,
    String? displayName,
  ) =>
